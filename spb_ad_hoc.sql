...
SELECT region,
	   ...
	   ROUND(COUNT(*) FILTER (WHERE rooms = 0)::NUMERIC / COUNT(*), 3) AS studio_perc,
	   ROUND(COUNT(*) FILTER (WHERE is_apartment = 1)::NUMERIC / COUNT(*), 3) AS apart_perc,
	   ROUND(COUNT(*) FILTER (WHERE open_plan = 1)::NUMERIC / COUNT(*), 3) AS open_plan_perc,
